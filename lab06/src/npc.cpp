...
bool NPC::visit(std::shared_ptr<Robber> robber) { return this->fight(robber); }
bool NPC::visit(std::shared_ptr<Wolf> wolf) { return this->fight(wolf); }
bool NPC::visit(std::shared_ptr<Bear> bear) { return this->fight(bear); }
